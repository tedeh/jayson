...
export declare class Utils {
  ...
  static request(
    ...
    id?: JSONRPCIDLike | null | undefined,
    options?: GenerateRequestOptions
  ): JSONRPCRequest;

  static response(
    error: JSONRPCError | undefined | null,
    result: JSONRPCResultLike | undefined | null,
    id: JSONRPCIDLike | null | undefined,
    version?: number
  ): JSONRPCVersionTwoResponse;
  static response(
    error: JSONRPCError | undefined | null,
    result: JSONRPCResultLike | undefined | null,
    id: JSONRPCIDLike | null | undefined,
  ...
  static parseStream(
    stream: Stream,
    options: UtilsJSONParseOptions,
    onRequest: (err?: Error, data?: any) => void
  ): void;
...
type UtilsJSON = {
  parse(
    str: string,
    options: UtilsJSONParseOptions | null | undefined,
    callback: (err?: Error, obj?: object) => void
  ): void;
  stringify(
    obj: object,
...
export interface MethodHandlerContext {
  ...
  ): Promise<JSONRPCResultLike> | void;
}
...
type MethodConstructor = ConstructorOf<
  Method,
  [options: MethodOptions] | [handler?: MethodHandlerType, options?: MethodOptions]
>;
...
export interface Method {
  ...
  execute(
    server: Server,
    requestParams: RequestParamsLike,
    context: object,
...
type ServerConstructor = ConstructorOf<
  Server,
  [methods?: { [methodName: string]: MethodLike }, options?: ServerOptions]
> & {
...
export interface Server extends events.EventEmitter {
  ...
  call(
    request: JSONRPCRequestLike | Array<JSONRPCRequestLike>,
    context: object,
    originalCallback?: ServerCallCallbackType
  ): void;
