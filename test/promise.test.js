...
describe('jayson/promise', function () {
  ...
  describe('client', function () {
    ...
    const suites = {
      ...
      browser: {
        ...
        client: function (server) {
          return jaysonPromiseBrowserClient(
            function (request) {
              const options = {
                method: 'POST',
                body: request,
              ...
              return fetch('http://localhost:3999', options).then(function (res) {
                return res.text();
              });
            },
            {
      ...
      describe(name, function () {
        ...
        describe('request', function () {
          it('should do a request and fulfill a promise', function () {
            return should(client.request('add', [333, 333]))
              .be.fulfilled()
              .catch((err) => {
          ...
          it('should do a request and fulfill a promise that errored', function () {
            return should(client.request('error', []))
              .be.fulfilled()
              .then(function (response) {
          ...
          it('should accept an array of requests and make a batch', function () {
            ...
            return should(client.request(batch))
              .be.fulfilled()
  ...
  describe('method', function () {
    ...
    describe('instance', function () {
      let method = null,
        server = new jaysonPromise.Server();
      beforeEach(function () {
        method = new Method({});
      });
